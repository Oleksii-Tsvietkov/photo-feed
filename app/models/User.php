...
class User extends AbstractModel
{
     ...
     */
    public function find(string $identity, string $pass) : ?array    //ToDo: it is safe to pass not hashed password?
    {
     ...
     * @param string $identity login or email of user
     * @return array returns array of user data if find him, empty array if query error occurs or null if user not find 
     */
    ...
    /**
     * Adds user to database table, hash inputtedpassword, returns true if user added successfully.
