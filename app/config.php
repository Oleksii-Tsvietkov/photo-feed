...
const MAIN_DESCRIPTION = "Share highlights, photos, and videos on the Photo Feed! Connect with friends, run your own blog, and watch Reels and Stories in real time. Join us!";    // ToDo: change
